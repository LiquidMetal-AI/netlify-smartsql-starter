...
import { type Raindrop } from "../client.mjs";
...
export declare class PagePromise<PageClass extends AbstractPage<Item>, Item = ReturnType<PageClass['getPaginatedItems']>[number]> extends APIPromise<PageClass> implements AsyncIterable<Item> {
    constructor(client: Raindrop, request: Promise<APIResponseProps>, Page: new (...args: ConstructorParameters<typeof AbstractPage>) => PageClass);
    /**
...
export declare namespace PageNumberResponse {
...
export declare class PageNumber<Item> extends AbstractPage<Item> implements PageNumberResponse<Item> {
    results: Array<Item>;
    pagination: PageNumberResponse.Pagination;
    constructor(client: Raindrop, response: Response, body: PageNumberResponse<Item>, options: FinalRequestOptions);
