...
exports.PageNumber = exports.PagePromise = exports.AbstractPage = void 0;
...
class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new error_1.RaindropError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
...
class PageNumber extends AbstractPage {
    constructor(client, response, body, options) {
    ...
    nextPageRequestOptions() {
        ...
        return {
            ...this.options,
            body: {
                ...(0, values_1.maybeObj)(this.options.body),
                page: currentPage + 1,
            },
        };
    }
