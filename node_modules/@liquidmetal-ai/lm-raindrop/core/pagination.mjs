...
import { RaindropError } from "./error.mjs";
...
export class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new RaindropError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
...
export class PageNumber extends AbstractPage {
    constructor(client, response, body, options) {
