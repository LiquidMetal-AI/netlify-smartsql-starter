...
export declare class ByStatus extends APIResource {
    /**
     ...
     * ```
     */
    listObjects(body: ByStatusListObjectsParams, options?: RequestOptions): APIPromise<ByStatusListObjectsResponse>;
}
...
export declare namespace ByStatusListObjectsResponse {
    interface Document {
        /**
...
export declare namespace ByStatus {
    export { type ByStatusListObjectsResponse as ByStatusListObjectsResponse, type ByStatusListObjectsParams as ByStatusListObjectsParams, };
}
//# sourceMappingURL=by-status.d.ts.map