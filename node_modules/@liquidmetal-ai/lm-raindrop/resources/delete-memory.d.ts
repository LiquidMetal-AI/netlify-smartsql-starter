...
export declare class DeleteMemory extends APIResource {
    /**
...
export declare namespace DeleteMemoryCreateParams {
...
export declare namespace DeleteMemory {
    export { type DeleteMemoryCreateResponse as DeleteMemoryCreateResponse, type DeleteMemoryCreateParams as DeleteMemoryCreateParams, };
}
