...
export declare class DeleteProcedure extends APIResource {
    /**
     ...
     * ```
     */
    create(body: DeleteProcedureCreateParams, options?: RequestOptions): APIPromise<DeleteProcedureCreateResponse>;
}
...
export declare namespace DeleteProcedureCreateParams {
...
export declare namespace DeleteProcedure {
    export { type DeleteProcedureCreateResponse as DeleteProcedureCreateResponse, type DeleteProcedureCreateParams as DeleteProcedureCreateParams, };
}
//# sourceMappingURL=delete-procedure.d.mts.map