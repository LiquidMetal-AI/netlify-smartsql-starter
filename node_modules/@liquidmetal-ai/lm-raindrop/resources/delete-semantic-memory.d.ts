...
export declare class DeleteSemanticMemory extends APIResource {
    /**
     ...
     * ```
     */
    delete(body: DeleteSemanticMemoryDeleteParams, options?: RequestOptions): APIPromise<DeleteSemanticMemoryDeleteResponse>;
}
...
export declare namespace DeleteSemanticMemoryDeleteParams {
...
export declare namespace DeleteSemanticMemory {
    export { type DeleteSemanticMemoryDeleteResponse as DeleteSemanticMemoryDeleteResponse, type DeleteSemanticMemoryDeleteParams as DeleteSemanticMemoryDeleteParams, };
}
//# sourceMappingURL=delete-semantic-memory.d.ts.map