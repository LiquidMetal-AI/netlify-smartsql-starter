...
export declare class DocumentStatusBulk extends APIResource {
    /**
     ...
     * ```
     */
    getStatusBulk(body: DocumentStatusBulkGetStatusBulkParams, options?: RequestOptions): APIPromise<DocumentStatusBulkGetStatusBulkResponse>;
}
...
export declare namespace DocumentStatusBulkGetStatusBulkResponse {
    interface Document {
        /**
...
export declare namespace DocumentStatusBulk {
    export { type DocumentStatusBulkGetStatusBulkResponse as DocumentStatusBulkGetStatusBulkResponse, type DocumentStatusBulkGetStatusBulkParams as DocumentStatusBulkGetStatusBulkParams, };
}
//# sourceMappingURL=document-status-bulk.d.ts.map