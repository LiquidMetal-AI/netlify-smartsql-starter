...
export declare class DocumentStatus extends APIResource {
    /**
     ...
     * ```
     */
    getStatus(body: DocumentStatusGetStatusParams, options?: RequestOptions): APIPromise<DocumentStatusGetStatusResponse>;
}
...
export declare namespace DocumentStatusGetStatusResponse {
    /**
     * Embedding stage information
     */
    interface Embedding {
...
export declare namespace DocumentStatus {
    export { type DocumentStatusGetStatusResponse as DocumentStatusGetStatusResponse, type DocumentStatusGetStatusParams as DocumentStatusGetStatusParams, };
}
//# sourceMappingURL=document-status.d.mts.map