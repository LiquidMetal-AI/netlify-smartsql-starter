...
export declare class EndSession extends APIResource {
    /**
...
export declare namespace EndSessionCreateParams {
...
export declare namespace EndSession {
    export { type EndSessionCreateResponse as EndSessionCreateResponse, type EndSessionCreateParams as EndSessionCreateParams, };
}
//# sourceMappingURL=end-session.d.mts.map