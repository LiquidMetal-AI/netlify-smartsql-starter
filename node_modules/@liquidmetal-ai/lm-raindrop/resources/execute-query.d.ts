...
export declare class ExecuteQuery extends APIResource {
    /**
     ...
     * ```
     */
    execute(body: ExecuteQueryExecuteParams, options?: RequestOptions): APIPromise<ExecuteQueryExecuteResponse>;
}
export type ExecuteQueryExecuteResponse = ExecuteQueryExecuteResponse.CsvResults | ExecuteQueryExecuteResponse.JsonResults;
export declare namespace ExecuteQueryExecuteResponse {
...
export declare namespace ExecuteQueryExecuteParams {
    interface SmartSql {
        /**
...
export declare namespace ExecuteQuery {
    export { type ExecuteQueryExecuteResponse as ExecuteQueryExecuteResponse, type ExecuteQueryExecuteParams as ExecuteQueryExecuteParams, };
}
