...
export declare class GetMemory extends APIResource {
    /**
...
export declare namespace GetMemoryRetrieveResponse {
    interface Memory {
        /**
...
export declare namespace GetMemoryRetrieveParams {
...
export declare namespace GetMemory {
    export { type GetMemoryRetrieveResponse as GetMemoryRetrieveResponse, type GetMemoryRetrieveParams as GetMemoryRetrieveParams, };
}
//# sourceMappingURL=get-memory.d.mts.map