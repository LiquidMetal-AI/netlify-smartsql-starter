...
export declare class GetMetadata extends APIResource {
    /**
     ...
     * ```
     */
    retrieve(body: GetMetadataRetrieveParams, options?: RequestOptions): APIPromise<GetMetadataRetrieveResponse>;
}
...
export declare namespace GetMetadataRetrieveResponse {
    interface Table {
        /**
...
export declare namespace GetMetadataRetrieveParams {
    interface SmartSql {
        /**
...
export declare namespace GetMetadata {
    export { type GetMetadataRetrieveResponse as GetMetadataRetrieveResponse, type GetMetadataRetrieveParams as GetMetadataRetrieveParams, };
}
