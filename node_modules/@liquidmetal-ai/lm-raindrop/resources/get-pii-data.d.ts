...
export declare class GetPiiData extends APIResource {
    /**
...
export declare namespace GetPiiDataRetrieveResponse {
...
export declare namespace GetPiiDataRetrieveParams {
    interface SmartSql {
        /**
...
export declare namespace GetPiiData {
    export { type GetPiiDataRetrieveResponse as GetPiiDataRetrieveResponse, type GetPiiDataRetrieveParams as GetPiiDataRetrieveParams, };
}
//# sourceMappingURL=get-pii-data.d.ts.map