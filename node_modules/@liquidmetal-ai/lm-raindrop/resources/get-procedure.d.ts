...
export declare class GetProcedure extends APIResource {
    /**
...
export declare namespace GetProcedureCreateParams {
...
export declare namespace GetProcedure {
    export { type GetProcedureCreateResponse as GetProcedureCreateResponse, type GetProcedureCreateParams as GetProcedureCreateParams, };
}
//# sourceMappingURL=get-procedure.d.ts.map