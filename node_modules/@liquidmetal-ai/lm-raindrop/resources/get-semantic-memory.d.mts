...
export declare class GetSemanticMemory extends APIResource {
    /**
     ...
     * ```
     */
    create(body: GetSemanticMemoryCreateParams, options?: RequestOptions): APIPromise<GetSemanticMemoryCreateResponse>;
}
...
export declare namespace GetSemanticMemoryCreateParams {
...
export declare namespace GetSemanticMemory {
    export { type GetSemanticMemoryCreateResponse as GetSemanticMemoryCreateResponse, type GetSemanticMemoryCreateParams as GetSemanticMemoryCreateParams, };
}
//# sourceMappingURL=get-semantic-memory.d.mts.map