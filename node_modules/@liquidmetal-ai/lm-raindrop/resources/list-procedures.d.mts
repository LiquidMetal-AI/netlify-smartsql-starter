...
export declare class ListProcedures extends APIResource {
    /**
...
export declare namespace ListProcedureCreateResponse {
    interface Procedure {
        /**
...
export declare namespace ListProcedureCreateParams {
...
export declare namespace ListProcedures {
    export { type ListProcedureCreateResponse as ListProcedureCreateResponse, type ListProcedureCreateParams as ListProcedureCreateParams, };
}
//# sourceMappingURL=list-procedures.d.mts.map