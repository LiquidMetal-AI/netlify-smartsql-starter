...
export declare class PutSemanticMemory extends APIResource {
    /**
     ...
     * ```
     */
    create(body: PutSemanticMemoryCreateParams, options?: RequestOptions): APIPromise<PutSemanticMemoryCreateResponse>;
}
...
export declare namespace PutSemanticMemoryCreateParams {
...
export declare namespace PutSemanticMemory {
    export { type PutSemanticMemoryCreateResponse as PutSemanticMemoryCreateResponse, type PutSemanticMemoryCreateParams as PutSemanticMemoryCreateParams, };
}
//# sourceMappingURL=put-semantic-memory.d.ts.map