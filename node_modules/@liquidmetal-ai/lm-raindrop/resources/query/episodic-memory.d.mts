...
export declare class EpisodicMemory extends APIResource {
    /**
     ...
     * ```
     */
    search(body: EpisodicMemorySearchParams, options?: RequestOptions): APIPromise<EpisodicMemorySearchResponse>;
}
...
export declare namespace EpisodicMemorySearchResponse {
    interface Entry {
        /**
...
export declare namespace EpisodicMemorySearchParams {
...
export declare namespace EpisodicMemory {
    export { type EpisodicMemorySearchResponse as EpisodicMemorySearchResponse, type EpisodicMemorySearchParams as EpisodicMemorySearchParams, };
}
//# sourceMappingURL=episodic-memory.d.mts.map