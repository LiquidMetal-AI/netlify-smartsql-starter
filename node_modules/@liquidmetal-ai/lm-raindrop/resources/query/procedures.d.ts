...
export declare class Procedures extends APIResource {
    /**
...
export declare namespace ProcedureSearchResponse {
    interface Procedure {
        /**
...
export declare namespace ProcedureSearchParams {
...
export declare namespace Procedures {
    export { type ProcedureSearchResponse as ProcedureSearchResponse, type ProcedureSearchParams as ProcedureSearchParams, };
}
