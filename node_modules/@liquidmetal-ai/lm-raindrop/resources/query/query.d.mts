...
import * as QueryAPI from "./query.mjs";
import * as Shared from "../shared.mjs";
import * as EpisodicMemoryAPI from "./episodic-memory.mjs";
import { EpisodicMemory, EpisodicMemorySearchParams, EpisodicMemorySearchResponse } from "./episodic-memory.mjs";
import * as MemoryAPI from "./memory.mjs";
import { Memory, MemorySearchParams, MemorySearchResponse } from "./memory.mjs";
import * as ProceduresAPI from "./procedures.mjs";
import { ProcedureSearchParams, ProcedureSearchResponse, Procedures } from "./procedures.mjs";
import * as SemanticMemoryAPI from "./semantic-memory.mjs";
import { SemanticMemory, SemanticMemorySearchParams, SemanticMemorySearchResponse } from "./semantic-memory.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { PageNumber, type PageNumberParams, PagePromise } from "../../core/pagination.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class Query extends APIResource {
    memory: MemoryAPI.Memory;
    episodicMemory: EpisodicMemoryAPI.EpisodicMemory;
    procedures: ProceduresAPI.Procedures;
    semanticMemory: SemanticMemoryAPI.SemanticMemory;
    /**
     ...
     * ```
     */
    documentQuery(body: QueryDocumentQueryParams, options?: RequestOptions): APIPromise<QueryDocumentQueryResponse>;
    /**
     ...
     * ```
     */
    getPaginatedSearch(body: QueryGetPaginatedSearchParams, options?: RequestOptions): PagePromise<LiquidmetalV1alpha1TextResultsPageNumber, LiquidmetalV1alpha1TextResult>;
    /**
     ...
     * ```
     */
    sumarizePage(body: QuerySumarizePageParams, options?: RequestOptions): APIPromise<QuerySumarizePageResponse>;
}
...
export declare namespace BucketLocator {
    interface Bucket {
        /**
...
export declare namespace QuerySearchResponse {
    /**
     * Pagination details for result navigation
     */
...
export declare namespace Query {
    export { type BucketLocator as BucketLocator, type LiquidmetalV1alpha1BucketName as LiquidmetalV1alpha1BucketName, type LiquidmetalV1alpha1SourceResult as LiquidmetalV1alpha1SourceResult, type LiquidmetalV1alpha1TextResult as LiquidmetalV1alpha1TextResult, type QueryChunkSearchResponse as QueryChunkSearchResponse, type QueryDocumentQueryResponse as QueryDocumentQueryResponse, type QuerySearchResponse as QuerySearchResponse, type QuerySumarizePageResponse as QuerySumarizePageResponse, type LiquidmetalV1alpha1TextResultsPageNumber as LiquidmetalV1alpha1TextResultsPageNumber, type QueryChunkSearchParams as QueryChunkSearchParams, type QueryDocumentQueryParams as QueryDocumentQueryParams, type QueryGetPaginatedSearchParams as QueryGetPaginatedSearchParams, type QuerySearchParams as QuerySearchParams, type QuerySumarizePageParams as QuerySumarizePageParams, };
    export { Memory as Memory, type MemorySearchResponse as MemorySearchResponse, type MemorySearchParams as MemorySearchParams, };
    export { EpisodicMemory as EpisodicMemory, type EpisodicMemorySearchResponse as EpisodicMemorySearchResponse, type EpisodicMemorySearchParams as EpisodicMemorySearchParams, };
    export { Procedures as Procedures, type ProcedureSearchResponse as ProcedureSearchResponse, type ProcedureSearchParams as ProcedureSearchParams, };
    export { SemanticMemory as SemanticMemory, type SemanticMemorySearchResponse as SemanticMemorySearchResponse, type SemanticMemorySearchParams as SemanticMemorySearchParams, };
}
