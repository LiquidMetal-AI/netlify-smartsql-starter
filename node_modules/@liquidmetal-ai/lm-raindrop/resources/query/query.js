...
const EpisodicMemoryAPI = tslib_1.__importStar(require("./episodic-memory.js"));
const episodic_memory_1 = require("./episodic-memory.js");
const MemoryAPI = tslib_1.__importStar(require("./memory.js"));
const memory_1 = require("./memory.js");
const ProceduresAPI = tslib_1.__importStar(require("./procedures.js"));
const procedures_1 = require("./procedures.js");
const SemanticMemoryAPI = tslib_1.__importStar(require("./semantic-memory.js"));
const semantic_memory_1 = require("./semantic-memory.js");
const pagination_1 = require("../../core/pagination.js");
class Query extends resource_1.APIResource {
    constructor() {
        super(...arguments);
    ...
    getPaginatedSearch(body, options) {
        return this._client.getAPIList('/v1/search_get_page', (pagination_1.PageNumber), {
            body,
            method: 'post',
            ...options,
        });
...
exports.Query = Query;
Query.Memory = memory_1.Memory;
Query.EpisodicMemory = episodic_memory_1.EpisodicMemory;
Query.Procedures = procedures_1.Procedures;
Query.SemanticMemory = semantic_memory_1.SemanticMemory;
