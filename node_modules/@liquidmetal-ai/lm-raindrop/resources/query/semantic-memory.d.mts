...
export declare class SemanticMemory extends APIResource {
    /**
     ...
     * ```
     */
    search(body: SemanticMemorySearchParams, options?: RequestOptions): APIPromise<SemanticMemorySearchResponse>;
}
...
export declare namespace SemanticMemorySearchResponse {
    /**
     * Search results with matching documents
     */
    ...
    namespace DocumentSearchResponse {
        interface Result {
            /**
...
export declare namespace SemanticMemorySearchParams {
...
export declare namespace SemanticMemory {
    export { type SemanticMemorySearchResponse as SemanticMemorySearchResponse, type SemanticMemorySearchParams as SemanticMemorySearchParams, };
}
//# sourceMappingURL=semantic-memory.d.mts.map