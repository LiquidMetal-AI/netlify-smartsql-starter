...
export declare class RehydrateSession extends APIResource {
    /**
     ...
     * ```
     */
    rehydrate(body: RehydrateSessionRehydrateParams, options?: RequestOptions): APIPromise<RehydrateSessionRehydrateResponse>;
}
...
export declare namespace RehydrateSessionRehydrateParams {
...
export declare namespace RehydrateSession {
    export { type RehydrateSessionRehydrateResponse as RehydrateSessionRehydrateResponse, type RehydrateSessionRehydrateParams as RehydrateSessionRehydrateParams, };
}
//# sourceMappingURL=rehydrate-session.d.mts.map