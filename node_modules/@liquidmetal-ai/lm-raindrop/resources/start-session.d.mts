...
export declare class StartSession extends APIResource {
    /**
...
export declare namespace StartSessionCreateParams {
...
export declare namespace StartSession {
    export { type StartSessionCreateResponse as StartSessionCreateResponse, type StartSessionCreateParams as StartSessionCreateParams, };
}
//# sourceMappingURL=start-session.d.mts.map