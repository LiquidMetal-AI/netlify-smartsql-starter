...
export declare class SummarizeMemory extends APIResource {
    /**
     ...
     * ```
     */
    create(body: SummarizeMemoryCreateParams, options?: RequestOptions): APIPromise<SummarizeMemoryCreateResponse>;
}
...
export declare namespace SummarizeMemoryCreateParams {
...
export declare namespace SummarizeMemory {
    export { type SummarizeMemoryCreateResponse as SummarizeMemoryCreateResponse, type SummarizeMemoryCreateParams as SummarizeMemoryCreateParams, };
}
//# sourceMappingURL=summarize-memory.d.mts.map