...
export declare class UpdateMetadata extends APIResource {
    /**
     ...
     * ```
     */
    update(body: UpdateMetadataUpdateParams, options?: RequestOptions): APIPromise<UpdateMetadataUpdateResponse>;
}
...
export interface UpdateMetadataUpdateParams {
     ...
     * entries)
     */
    mode?: 'UPDATE_MODE_UNSPECIFIED' | 'UPDATE_MODE_REPLACE' | 'UPDATE_MODE_MERGE' | 'UPDATE_MODE_APPEND' | null;
}
export declare namespace UpdateMetadataUpdateParams {
    interface SmartSql {
        /**
...
export declare namespace UpdateMetadata {
    export { type UpdateMetadataUpdateResponse as UpdateMetadataUpdateResponse, type UpdateMetadataUpdateParams as UpdateMetadataUpdateParams, };
}
//# sourceMappingURL=update-metadata.d.mts.map