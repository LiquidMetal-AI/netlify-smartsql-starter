...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['RAINDROP_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['RAINDROP_LOG'] or 'warn' if it isn't set.
   */
...
export class Raindrop {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Raindrop.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('RAINDROP_LOG'), "process.env['RAINDROP_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.raindrop.run';
  }
  ...
  static Raindrop = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static RaindropError = Errors.RaindropError;
