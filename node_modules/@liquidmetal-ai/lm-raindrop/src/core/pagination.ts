...
export abstract class AbstractPage<Item> implements AsyncIterable<Item> {
  ...
  constructor(client: Raindrop, response: Response, body: unknown, options: FinalRequestOptions) {
    this.#client = client;
...
export interface PageNumberResponse<Item> {
  ...
  pagination: PageNumberResponse.Pagination;
}
