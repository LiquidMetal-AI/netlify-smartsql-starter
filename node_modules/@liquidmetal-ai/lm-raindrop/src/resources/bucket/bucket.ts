...
import * as ByStatusAPI from './by-status';
import { ByStatus, ByStatusListObjectsParams, ByStatusListObjectsResponse } from './by-status';
import * as QueryAPI from '../query/query';
import { APIPromise } from '../../core/api-promise';
import { RequestOptions } from '../../internal/request-options';

export class Bucket extends APIResource {
  byStatus: ByStatusAPI.ByStatus = new ByStatusAPI.ByStatus(this._client);
